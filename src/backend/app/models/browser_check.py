...
class BrowserCheck(Base):
    ...
    console_errors: Mapped[list] = mapped_column(JSONB, default=list, nullable=False)
    failed_assertions: Mapped[list] = mapped_column(JSONB, default=list, nullable=False)
